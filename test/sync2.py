...
class SimpleLaggingTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.data2['difficulty'] = 2
        self.data2['reset'] = True

        generateBlocksResponse1 = test.generateBlocks(self.peer1, defaultPortNo, self.data1)
        generateBlocksResponse2 = test.generateBlocks(self.peer2, defaultPortNo, self.data2)

        if verbose:
            topBlock1 = test.getTopBlock(self.peer1, defaultPortNo)
            topBlock2 = test.getTopBlock(self.peer2, defaultPortNo)
            print("topBlock1:")
    ...
    def test_sync(self):
        if verbose:
            print("############################################### Syncing ###############################################")
        test.initiateSync(self.peer1, defaultPortNo, self.peer2)
        topBlock1 = test.getTopBlock(self.peer1, defaultPortNo)
        topBlock2 = test.getTopBlock(self.peer2, defaultPortNo)
        if verbose:
            print("topBlock1:")
